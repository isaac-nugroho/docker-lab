...
if [[ -e $CASSANDRA_DATA/current_address.txt ]]; then
  cat $CASSANDRA_DATA/current_address.txt > $CASSANDRA_DATA/previous_address.txt
else
  rm -f $CASSANDRA_DATA/previous_address.txt
fi
hostname -i > $CASSANDRA_DATA/current_address.txt
